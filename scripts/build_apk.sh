...
echo "Building APK with API_BASE_URL=$API_URL (A4-only production; LAB_MODES off)"
flutter pub get
flutter build apk --release --dart-define="API_BASE_URL=$API_URL" --dart-define=LAB_MODES=false
